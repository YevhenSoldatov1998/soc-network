...
import {InitializationApp, InitialStateType} from "./redux/init-reducer";
...
// }
// let mapStateToProps = (state: AppState): InitialStateType => {
//     return {
//         initialized: state.init.initialized
//     }
// }
...
// export default compose(
//     withRouter,
//     connect<InitialStateType, MapDispatchToPropsType, {}, AppState>(mapStateToProps, {InitializationApp}),
//     React.memo
// )(App);
